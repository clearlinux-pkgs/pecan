...
Version  : 1.4.0
Release  : 72
URL      : https://files.pythonhosted.org/packages/4d/8e/da71e4e23b720805106b58e0351dcd75d8ffc7c7ac3ad2961b20b98a44a7/pecan-1.4.0.tar.gz
...
%prep
%setup -q -n pecan-1.4.0
cd %{_builddir}/pecan-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625014463
...
cp %{_builddir}/pecan-1.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pecan/468e4ca7bcd01061db356986e1746fb35002930d
